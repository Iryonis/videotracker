...
#Test pour exportDataToCsv :
    ...
    def test_exportDataToCsvTrue(self):
        self.fileCSV.exportDataToCsv(self.dataTimes, self.dataPoints)
        self.assertTrue(filecmp.cmp("~/VideoTracker/VideoTracker/resources/resultats/releve_de_points.csv","verificationtrue.csv"))

    def test_exportDataToCsvFalse(self):
        self.fileCSV.exportDataToCsv(self.dataTimes, self.dataPoints)
        self.assertFalse(filecmp.cmp("~/VideoTracker/VideoTracker/resources/resultats/releve_de_points.csv","verificationfalse.csv"))
